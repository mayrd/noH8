...
| Tests | Vitest (48 files / 410 tests). jsdom only for `.tsx` component suites |
...
> gate: TypeScript must pass, all tests must pass (48 files / 410 tests as of
> L2), and the production build must succeed. The GitHub Actions `release.yml`
